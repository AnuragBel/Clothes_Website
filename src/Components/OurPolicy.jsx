...
const OurPolicy = () => {
  return (
    <div className='flex flex-col sm:flex-row justify-around gap-12 sm:gap-2 text-center py-20 text-xs sm:text-sm md:text-base text-gray-700'>
      ...
      <div>
        <img className='w-12 m-auto md-5' src={assets.exchange_icon}/>
        <p className='font-semibold'> Easy Exchange Policy </p>
        <p className='text-gray-600'>We offer hassle free Exchange Policy</p>
      </div>

      <div>
        <img className='w-12 m-auto md-5' src={assets.quality_icon}/>
        <p className='font-semibold'> 7 Days Return policy </p>
        <p className='text-gray-600'>We provide 7 days free Return Policy</p>
      </div>

      <div>
        <img className='w-12 m-auto md-5' src={assets.support_img}/>
