    ...
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-top'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <div className='flex gap-3'>
          ...
          <input className='border border-gray-500 rounded py-1.5 px-3.5 w-full' type='text' placeholder='Address'/>
        ...
        <div className='flex gap-3'>
          <input className='border border-gray-500 rounded py-1.5 px-3.5 w-full' type='number' placeholder='Contact No 1'/>
          <input className='border border-gray-500 rounded py-1.5 px-3.5 w-full' type='number' placeholder='Contact No 2'/>
        </div>
      </div>
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='w-full text-end mt-8'>
            <button onClick={()=>Navigate('/orders')} className='bg-black text-white mx-40 px-16 py-3 text-sm'>PLACE ORDER</button>
          </div>
      </div> 
    </div>
  )
